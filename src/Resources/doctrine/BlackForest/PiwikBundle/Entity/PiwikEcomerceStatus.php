 ...
 * PiwikEcomerceStatus
 *
 * @ORM\Table(name="piwik_ecommerce_status")
 * @ORM\Entity(repositoryClass="BlackForest\PiwikBundle\Entity\PiwikEcomerceStatusRepository")
 */
class PiwikEcomerceStatus
{
    /**
     * @var string
     *
     ...
     *
     * @ORM\OneToMany(targetEntity="BlackForest\PiwikBundle\Entity\PiwikVisit", mappedBy="ecommmerceStatus")
     */
    private $visit;
     ...
     *
     * @ORM\ManyToOne(targetEntity="BlackForest\PiwikBundle\Entity\PiwikSite", inversedBy="ecomerceStatus")
     * @ORM\JoinColumns({
